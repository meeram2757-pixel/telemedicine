...
import Notifications from "./screen/patient/pages/Notifications";
import HealthLogs from "./screen/patient/pages/HealthLogs";
import LabReports from "./screen/patient/pages/LabReports";
