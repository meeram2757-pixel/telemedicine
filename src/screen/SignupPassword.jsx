...
const SignupPassword = () => {
  ...
  const handleCreateAccount = async () => {
    ...
    const role = localStorage.getItem("signupProvider");

    if (!email || !otp) {
      setError("Signup data is missing. Please request a new OTP.");
      setSuccess("");
      return;
    }

    if (!role) {
      setError("Account type not selected. Please restart the signup process.");
      return;
    }
  ...
  return (
    <div className="auth-container" style={{ backgroundImage: `url(${bgImage})` }}>
      <div className="auth-form-section">
          ...
          <p className="auth-subtitle">Set your password to complete sign up.</p>
          ...
          <button onClick={handleCreateAccount} className="btn-primary mb-6">
            Create password
          </button>
